...
LOG_FILE = LOGS_DIR / "backfill_2026.log"
...
def get_2026_fridays() -> list[date]:
    """Generate a list of dates for every Friday in 2026."""
    start_date = date(2026, 1, 2)  # First Friday of 2026
    end_date = date(2026, 5, 8)  # Last Friday of 2026
...
# ---------------------------------------------------------------------------
def run_backfill():
    fridays = get_2026_fridays()
    total_dates = len(fridays)
    logger.info(f"Starting backfill for {total_dates} Fridays in 2026.")
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("Initializing 2026 Backfill Pipeline (Weekly Friday Jump)")
    logger.info("=" * 60)
